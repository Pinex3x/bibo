...
const liveAPI = 'https://api.live.bilibili.com/xlive/web-interface/v1/webMain/getList?platform=web'
const changeAPI = 'https://api.live.bilibili.com/xlive/web-interface/v1/webMain/getMoreRecList?platform=web'
...
// POST
const mangaAPI = 'https://manga.bilibili.com/twirp/comic.v1.Comic/GetRecommendComics' // type: 1, page_size: 12, page_num: 1
